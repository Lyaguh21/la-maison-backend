...
async function main() {
  ...
  const reservationsData = [
    ...
    },
    {
      ...
      startTime: hour(12),
      endTime: hour(14),
      realStartTime: hour(12),
      realEndTime: hour(13),
      userId: null,
      guestName: 'Кондратьев Илья',
      guestPhone: '+79009990011',
      waiterId: waiter.id,
      items: [
        { dishIdx: 9, qty: 2 },
        { dishIdx: 16, qty: 1 },
    ...
    },
    {
      ...
      endTime: hour(19),
      userId: null,
      guestName: 'Ларионов Павел',
      guestPhone: '+79004445566',
      waiterId: null,
      items: [],
      orderStatus: null,
    },
